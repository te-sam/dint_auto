...
class WorkPage(BasePage):
    ...
    def add_new_project(self, name: str) -> None:
        ...
        ActionChains(self.driver).move_to_element(
            project_dots
        ).move_to_element(new_project_button).click().perform()
        sleep(1)
    ...
    def click_category_menu_models(self, category: int):
        locator_category = (
            By.CSS_SELECTOR,
            f"#main_menu_block > button:nth-child({category})",
        )
    ...
    def click_subcategory(self, subcategory: int):
        locator_subcategory = (
            By.CSS_SELECTOR,
            f"#ui > div.left-menu-block > div:nth-child(2) > div:nth-child(5) > div:nth-child({subcategory})",
        )
